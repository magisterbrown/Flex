...
function findNeighbors(id){
    ...
    if(!prevletter2.includes("Z") && !prevletter2.includes("13")){
      ret.push(prevletter2);
    }
    if(!nextletter.includes("L")){
      ret.push(nextletter);
    }
    if(!nextletter2.includes("L") && !nextletter2.includes("0")){
      ret.push(nextletter2);
    }
    if(!sameletter.includes("0")){
      ret.push(sameletter);
    }
    if(!sameletter2.includes("13")){
      ret.push(sameletter2);
    }
